...
function EndRoundScreen({navigation}:{navigation:any}) {
  ...
  const dispatch = useAppDispatch()
    ...
    const YakuList=()=>{
      ...
      let shitExample:YakuType[]=[{han:1,yakuName:"ToiToi"},{han:3,yakuName:"Tanyao"},{han:1,yakuName:"Junchan"},{han:2,yakuName:"Yakuhai"},{han:13,yakuName:"Chinitsu"},{han:4,yakuName:"Tsuuiisou"}]
      ...
      return(
        ...
        >
          ...
          renderItem={({ item, index }) => (
            <YakuRow key={index} data={item} time={index * 2400} /* onRendered={handleRendered} */ />
          )}          
          numColumns={4}
...
/*         marginHorizontal: 50,
      ...
      onPress={()=>{console.log("SCRENSHOT Pressed"), 
