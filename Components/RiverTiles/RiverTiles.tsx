...
export const TileInTheRiverComponentLeft =({svg,tileRatioProp=3,index}:{svg:string,tileRatioProp:number,index:number})=>{
...
export const TileInTheRiverComponentTop =({svg,tileRatioProp=3,index}:{svg:string,tileRatioProp:number,index:number})=>{
   ...
   return(
       <View style={{backgroundColor:'#56a2c4',height:tileBottomLayer,width:tileWidth,justifyContent:"flex-end",borderRadius:tileBorderRadiusHandPlayerPerspective,borderWidth:1,transform: [{rotate: `${richiiTile?90:0}deg`}]}}>
