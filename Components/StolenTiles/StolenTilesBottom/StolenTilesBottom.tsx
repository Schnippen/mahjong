...
return (
  <View style={{backgroundColor:"brown",width:150,height:80,flexDirection:"row",alignItems:"flex-end",justifyContent:"center"}}>
  <StolenTileComponentPlayerVERTICAL svg={data.tiles[0].image} tileRatioProp={1.5}/>
  <StolenTileComponentPlayerVERTICAL svg={data.tiles[1].image} tileRatioProp={1.5}/>
  <StolenTileComponentPlayerHORIZONTAL svg={data.tiles[2].image} tileRatioProp={1.5}/>
</View>
)
} 
...
export const  StolenTilesPlayerFRONT=({data}:{data:TstolenTiles})=>{
  ...
  <View style={{backgroundColor:"brown",width:150,height:80,flexDirection:"row",alignItems:"flex-end",justifyContent:"center"}}>
  <StolenTileComponentPlayerVERTICAL svg={data.tiles[0].image} tileRatioProp={1.5}/>
  <StolenTileComponentPlayerHORIZONTAL svg={data.tiles[1].image} tileRatioProp={1.5}/>
  <StolenTileComponentPlayerVERTICAL svg={data.tiles[2].image} tileRatioProp={1.5}/>
</View>
)
} 
...
export const  StolenTilesPlayerKANLEFT=({data}:{data:TstolenTiles})=>{
  ...
  <StolenTileComponentPlayerVERTICAL svg={data.tiles[1].image} tileRatioProp={1.5}/>
  <StolenTileComponentPlayerVERTICAL svg={data.tiles[2].image} tileRatioProp={1.5}/>
  <StolenTileComponentPlayerVERTICAL svg={data.tiles[3].image} tileRatioProp={1.5}/>
</View>
)
} 
...
return (
  ...
  <StolenTileComponentPlayerVERTICALReversed svg={data.tiles[0].image} tileRatioProp={1.5}/>
  <StolenTileComponentPlayerVERTICAL svg={data.tiles[1].image} tileRatioProp={1.5}/>
  <StolenTileComponentPlayerVERTICAL svg={data.tiles[2].image} tileRatioProp={1.5}/>
  <StolenTileComponentPlayerVERTICALReversed svg={data.tiles[3].image} tileRatioProp={1.5}/>
</View>
)
}